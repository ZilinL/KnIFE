...
def get_args():
    ...
    parser.add_argument('--algorithm', type=str, default="DIFEX_EEG_Revision")  #DIFEX_EEG_Revision_Augment
    ...
    parser.add_argument('--data_file', type=str, default='',
                        help='root_dir')
    parser.add_argument('--dataset', type=str, default='BCICIV-2a-9domain')
    parser.add_argument('--data_dir', type=str, default='./data/BCIC_IV_2a/data2_4Class_filtered/', help='data dir')  # ./data/BCIC_IV_2a/data2_4Class_filtered/  './data/BCIC_IV_2b/'
    ...
    parser.add_argument('--loss_type', type=str,
                        default='mmd', help="mutually invariant features loss")
    ...
    parser.add_argument('--max_epoch', type=int,
                        default=120, help="max iterations") #120
    ...
    parser.add_argument('--net', type=str, default='ShallowConveNet',  # DeepConveNet DeepConveNet_4 EEGNet ShallowConveNet
    ...
    print_environ()
    print(filename_out+args.loss_type) 
    return args
